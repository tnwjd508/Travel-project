...
export function GlowingPath() {
  const particles = [[12, 88], [18, 82], [26, 77], [33, 74], [46, 70], [60, 67], [72, 65]]
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 z-[1] h-[36%] min-h-[220px] overflow-hidden" aria-hidden="true">
      <svg viewBox="0 0 1600 360" preserveAspectRatio="none" className="absolute inset-0 h-full w-full overflow-visible">
        ...
        <motion.path d="M40 342C300 312 250 276 520 268C770 261 720 244 960 244C1090 244 1130 234 1270 226" fill="none" stroke="#FFB65C" strokeOpacity=".32" strokeWidth="18" filter="url(#roadGlow)" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2.3, delay: .75, ease: [0.16, 1, 0.3, 1] }} />
        <motion.path d="M40 342C300 312 250 276 520 268C770 261 720 244 960 244C1090 244 1130 234 1270 226" fill="none" stroke="url(#roadColor)" strokeWidth="2" strokeLinecap="round" initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{ duration: 2.2, delay: .72, ease: [0.16, 1, 0.3, 1] }} />
      </svg>
