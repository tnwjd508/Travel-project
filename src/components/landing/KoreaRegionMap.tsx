        ...
        return (
          ...
          >
            <motion.button
              ...
              className="group grid h-full w-full place-items-center rounded-full outline-none focus-visible:ring-2 focus-visible:ring-[#FFD89A] focus-visible:ring-offset-2 focus-visible:ring-offset-[#071020]"
            >
