...
export function KpiGrid() {
  ...
  const kpis = summary ? [
    ...
    { label: '관광체류강도', value: summary.stay.ix21, unit: '지수', note: '평균 체류시간이 아닌 상대 지수', decimals: 2 },
    { label: '관광소비강도', value: summary.spend.ix22, unit: '지수', note: '실제 소비 금액이 아닌 상대 지수', decimals: 2 },
