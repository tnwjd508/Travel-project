...
import { formatPct, formatRange, policyEvidence } from '@/data/festivalEffect'
import { useActiveDistrict } from '@/hooks/useActiveDistrict'
import { useDistrictResource } from '@/hooks/useDistrictResource'

export function StrategyTable({ currentPolicy }: { currentPolicy?: PolicyId }) {
