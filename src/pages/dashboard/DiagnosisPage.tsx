...
export function DiagnosisPage() {
  ...
  return <DashboardPageFrame eyebrow="AI Regional Diagnosis" title={`${district.nameKo} 관광의 핵심 문제를 진단합니다`} description="관광 활성화 지수와 데이터 근거를 바탕으로 우선 개선 과제를 도출했습니다." icon={BrainCircuit}>
